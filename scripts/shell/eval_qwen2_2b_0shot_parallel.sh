...
# Qwen2-VL-2B-Instruct 0-shot 并行评估脚本
...
MODEL_PATH="$WORK_DIR/models/Qwen2-VL-2B-Instruct"
DATA_PATH="$WORK_DIR/dataset/vlm_evaluation_v1.0"

# 规范化日志和结果目录
CONFIG_NAME="qwen2_2b_0shot"
LOG_DIR="$WORK_DIR/logs/$CONFIG_NAME"
RESULT_DIR="$WORK_DIR/results/$CONFIG_NAME"

mkdir -p "$LOG_DIR"

echo "开始 Qwen2-VL-2B-Instruct 0-shot 并行评估 (3路并发)..."
